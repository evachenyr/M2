 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Catherine Lee");
		  toPrint += p1.toString("clee654");
          ...
          Person4 p4 = new Person4("Sung Kang");
          toPrint += p4.toString("skang345");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Sam Thomas");
          toPrint += p5.toString("sthomas313");
